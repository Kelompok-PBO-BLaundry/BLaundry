...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style_login_admin.css">
</head>
<body>
    ...
    <main class="content d-flex justify-content-center align-items-center">
        <div class="form-container bg-white p-4 rounded shadow">
            ...
            <p class="link-text mt-3">
                <a href="${pageContext.request.contextPath}/register_cust.jsp" id="regist-link" class="highlight-link">Back to registration page</a>
            </p>
        </div>
    </main>
